        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav align-items-center ml-md-auto">
                    ...
                    <li><a class="btn btn-primary btn-md" style="background-color: #322A7D" href="http://wa.me/{{$sanboxNumber}}?text=join%20tongue-getting" target="_blank">Enable WhatsApp notifications</a></li>
