...
@section("restaurantcontant")
    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <a class="btn" style="background-color: #FFA101; opacity: 65%; color: #000000">Addons</a>
                ...
                <table class="table align-items-center table-flush">
                    ...
                    @foreach($addon as $add)
                        <tr>
                            ...
                            <td>{{ $add->price }}</td>
                            <td><a href="{{route('store_admin.update_addon',['id'=>$add->id])}}" title="edit" class="btn btn-sm btn-primary">
                                    Edit
                                </a></td>
